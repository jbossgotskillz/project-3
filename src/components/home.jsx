...
export default function Home() {
	...
	return (
        ...
        <h1 className="title text-center">Home</h1>
            ...
            <img src="./components/circuit_board2.jpg" height="200" class="d-flex mx-auto my-3" alt="circuit board" />
            ...
            <img src="./components/circuit_board2" height="200" class="d-flex mx-auto my-3" alt="circuit board"/> 
